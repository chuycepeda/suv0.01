...
_routes = [
    RedirectRoute('/admin/', admin.AdminSummaryHandler, name='admin-summary', strict_slash=True),
    
    RedirectRoute('/admin/inbox/', operator.AdminInboxHandler, name='admin-inbox', strict_slash=True),
    RedirectRoute('/admin/map/', operator.AdminMapHandler, name='admin-map', strict_slash=True),
    RedirectRoute('/admin/manual/', operator.AdminManualHandler, name='admin-manual', strict_slash=True),
    RedirectRoute('/admin/organization/view/', operator.AdminOrganizationViewHandler, name='admin-organization-view', strict_slash=True),
    ...
    RedirectRoute('/admin/subcategories/<category_id>/', operator.AdminSubcategoriesEditHandler, name='admin-subcategory-edit', strict_slash=True, handler_method='edit'),
    ...
    RedirectRoute('/taskqueue/admin/bulk/', operator.AdminBulkCategoriesHandler, name='admin-bulk', strict_slash=True),
]
