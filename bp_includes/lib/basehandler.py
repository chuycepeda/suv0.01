...
class BaseHandler(webapp2.RequestHandler):
    ...
    def render_template(self, filename, **kwargs):
        ...
        kwargs.update({
            ...
            'first_level_caps_singular' : self.app.config.get('first_level_caps_singular'),
            'first_level_caps_plural' : self.app.config.get('first_level_caps_plural'),
            'first_level_mins_singular' : self.app.config.get('first_level_mins_singular'),
            'first_level_mins_plural' : self.app.config.get('first_level_mins_plural'),
            'first_level_caps_person' : self.app.config.get('first_level_caps_person'),
            'second_level_caps_singular' : self.app.config.get('second_level_caps_singular'),
            'second_level_caps_plural' : self.app.config.get('second_level_caps_plural'),
            'second_level_mins_singular' : self.app.config.get('second_level_mins_singular'),
            'second_level_mins_plural' : self.app.config.get('second_level_mins_plural'),
            'second_level_caps_person' : self.app.config.get('second_level_caps_person'),
